...
from mapclientplugins.fieldworkmodeltriangulationstep.ui_configuredialog import Ui_Dialog
...
class ConfigureDialog(QtWidgets.QDialog):
    ...
    def validate(self):
        ...
        """
        # It's not currently possible for the configuration to be invalid.
        return True
